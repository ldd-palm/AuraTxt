...
|---------|------|---------|
| [AuraTXT_1.7.zip](https://github.com/ldd-palm/AuraTxt/releases/download/v1.7/AuraTXT_1.7.zip) | ~3 MB | Windows 10/11 + [.NET 8 Desktop Runtime](https://dotnet.microsoft.com/download/dotnet/8.0) |
| [AuraTXT_1.7_self_contained.zip](https://github.com/ldd-palm/AuraTxt/releases/download/v1.7/AuraTXT_1.7_self_contained.zip) | ~125 MB | Windows 10/11 only (no .NET install needed) |
